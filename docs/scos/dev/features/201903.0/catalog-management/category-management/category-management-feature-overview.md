...
You can assign new child categories to a parent one in the **Back Office > Category** section using the **Add category to this node** action. For more details, see [Creating Categories](/docs/scos/dev/user-guides/201903.0/back-office-user-guide/category/creating-categories.html).
