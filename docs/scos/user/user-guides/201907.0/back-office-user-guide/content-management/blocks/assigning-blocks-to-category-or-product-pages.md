...
You can only add existing, active, and not expired block. If the block has not been created yet, see [Creating a CMS Block](/docs/scos/dev/user-guides/201907.0/back-office-user-guide/content-management/blocks/creating-a-cms-block.html
{% endinfo_block %} first.)
...
{% info_block infoBox %}
See [CMS Block: Reference Information](/docs/scos/dev/user-guides/201907.0/back-office-user-guide/content-management/blocks/references/cms-block-reference-information.html
