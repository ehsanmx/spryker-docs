...
***
To learn more about the order statuses, see [Orders: Reference Information](/docs/scos/dev/user-guides/201903.0/back-office-user-guide/sales/orders/references/orders-reference-information.html).
***
## Claiming Orders
